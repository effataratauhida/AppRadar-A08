...
const Navbar = () => {
    return (
      ...
      <ul
        ...
        <Link to='/' className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] 
                            bg-clip-text text-transparent font-semibold text-base'>Home</Link>
                        <Link to='/apps' className='text-base font-medium text-black'>Apps</Link>
                        <Link to='/' className='text-base font-medium text-black'>Installation</Link>
      </ul>
                    </div>
                    <Link to='/' className="flex items-center gap-1 hover:scale-105 ml-[-10px]">
